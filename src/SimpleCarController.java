...
public class SimpleCarController implements CarController {
  ...
  public SimpleCarController(CarVisualizer car) {
    myCar = car;
  ...
  public SimpleCarController(CarVisualizer car, double[][] parentFunction) {
    myCar = car;
...
//    myCar.turnWheel(new Random().nextInt(200) - 100);
  ...
  public SimpleCarController produceOffspring(CarVisualizer car) {
